...
const LoanList = () => {
  ...
  return (
    <div className="p-4 lg:p-0 flex h-[calc(100vh-122px)] flex-col xl:flex-row w-full gap-x-6">
      <div className="w-5/6 border-2 border-primary-color-1 rounded-md lg:w-1/5 p-3 text-primary-color-1 dark:text-primary-color-7">
        <Link
          to={"/dashboard"}
          ...
          {loans.map((loan, index) => {
            return (
              <Link
                key={index}
                to={`loan/${loan.id}`}
                className="w-full hover:cursor-pointer rounded-md transition-all duration-500 text-primary-color-1 border-2 dark:text-primary-color-7 p-3 border-primary-color-1 dark:border-primary-color-7"
              >
                <div className="p-2">
                  ...
                  <div className="pt-2 grid grid-cols-2 lg:grid-cols-5 gap-x-6 mx-4">
                    <div className="flex items-center p-2 flex-col h-32 bg-white/25 border-2 border-primary-color-1 dark:border-primary-color-7 rounded-3xl">
                      ...
                      <span className="uppercase text-sm lg:text-lg">
                        Approx amount:-{" "}
                      </span>
                      <span className="font-semibold text-lg lg:text-3xl mx-auto">
                        {loan.approx_price} &#x20B9;
                      </span>
                    </div>
                    <div className="flex items-center p-2 flex-col h-32 bg-white/25 border-2 border-primary-color-1 dark:border-primary-color-7 rounded-3xl">
