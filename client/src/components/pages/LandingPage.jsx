  ...
  return (
    <div className="bg-primary-color-5 font-medium dark:bg-primary-color-8 h-screen grid place-items-center transition-all duration-500">
      <div className="flex max-w-screen-xl justify-between w-full">
        <div className="w-5/6 lg:w-1/2 flex flex-col gap-y-6 lg:px-24 text-primary-color-1 dark:text-primary-color-7 tracking-wider">
          <motion.p
            drag
          ...
          <Link
            to="/journey"
            className="border-2 w-max rounded-md border-primary-color-1 text-2xl p-4 transition-all hover:bg-primary-color-3 hover:text-primary-color-7 dark:border-primary-color-8 dark:bg-primary-color-3 dark:text-primary-color-4 dark:hover:bg-primary-color-7 duration-300"
          >
            Get my Loan options.
          </Link>
        </div>
