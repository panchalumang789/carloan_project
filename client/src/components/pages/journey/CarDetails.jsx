      ...
      >
        ...
        <div className="w-1/2 text-center">
          <form
            ...
            className="flex justify-center flex-col gap-y-3 w-60 mx-auto"
          >
            <select
              name="maker"
              id="maker"
            ...
            {errors.make && <span>Please select car model.</span>}
            ...
            >
              {cars.map((item) => {
                return (
                  <option key={item.model_type} value={item.id}>
                    {item.model_type}
                  </option>
                );
              })}
            </select>
            {errors.carId && <span>Please select car model.</span>}
