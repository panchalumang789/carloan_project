            ...
            <form onSubmit={handleSubmit(WorkDetails)} className='w-1/2 text-center'>
                <div>
                    ...
                    <div>
                        ...
                        <select name="user_status" id="user_status" defaultValue="" {...register('user_status', { required: true })}>
                    ...
                    <div>
                        ...
                        <input type="number" id='user_income' placeholder='Income' className='border' {...register('user_income', { required: true, min: 10000 })} />
