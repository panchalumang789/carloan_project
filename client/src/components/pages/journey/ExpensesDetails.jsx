    ...
    >
      ...
      <div className="w-1/2 text-center">
        ...
        <form onSubmit={handleSubmit(expensesDetails)}>
          <div>
            <label htmlFor="vehicle_running_cost">
          ...
          <div>
            ...
            />
            {errors.insurances && <span>This field is required.</span>}
          </div>
          <div>
            ...
            />
            {errors.telephone_internet && <span>This field is required.</span>}
          </div>
          <div>
            ...
            />
            {errors.entertainment && <span>This field is required.</span>}
          </div>
